...
# TODO: در رلیز نهایی برنامه، بعد از ساخت فایل مربوطه، خط زیر حتما حتما حتما غیر فعال شود
# در غیر اینصورت فایل اجرایی ساخته شده با پای اینستالر ممکن است کار نکند
